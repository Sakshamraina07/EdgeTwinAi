                            ...
                            <div className="space-y-1.5 text-[11px]">
                              ...
                              <div className="pt-1">
                                ...
                                <div className="grid grid-cols-2 gap-2 text-[10px] text-slate-300 font-mono">
                                  ...
                                  <div className="flex justify-between bg-slate-900/50 px-1.5 py-1 rounded border border-slate-800"><span>Load</span><span className="text-white">{(telemetry[selectedMachine].metrics.load / 10).toFixed(1)} kW</span></div>
